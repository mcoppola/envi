...
/*		[4,1,5, '-*-'], [6,1,5, '-*-'], [5,1,6, '-*-'], [5,1,4, '-*-'],*/		
	...
	this.sun2 = [
		[5,0,5, '.', '#880000 '], [0,5,5, '.', '#880000 '], [10,5,5, '.', '#880000 '], [5,10,5, '.', '#880000 '],  /* corners */
		[5,5,0, '.', '#880000 '], [5,5,10, '.', '#880000 '],
		[4,1,5, '.', '#880000 '], [3,2,5, '.', '#880000 '], [2,3,5, '.', '#880000 '], [1,4,5, '.', '#880000 '],    /* sides */
		[6,1,5, '.', '#880000 '], [7,2,5, '.', '#880000 '], [8,3,5, '.', '#880000 '], [9,4,5, '.', '#880000 '],
		[4,9,5, '.', '#880000 '], [3,8,5, '.', '#880000 '], [2,7,5, '.', '#880000 '], [1,6,5, '.', '#880000 '],
		[6,9,5, '.', '#880000 '], [7,8,5, '.', '#880000 '], [8,7,5, '.', '#880000 '], [9,6,5, '.', '#880000 '],
		[5,1,4, '.', '#880000 '], [5,2,3, '.', '#880000 '], [5,3,2, '.', '#880000 '], [5,4,1, '.', '#880000 '],
		[5,1,6, '.', '#880000 '], [5,2,7, '.', '#880000 '], [5,3,8, '.', '#880000 '], [5,4,9, '.', '#880000 '],
		[5,9,4, '.', '#880000 '], [5,8,3, '.', '#880000 '], [5,7,2, '.', '#880000 '], [5,6,1, '.', '#880000 '],
		[5,9,6, '.', '#880000 '], [5,8,7, '.', '#880000 '], [5,7,8, '.', '#880000 '], [5,6,9, '.', '#880000 '],
		[4,5,1, '.', '#880000 '], [3,5,2, '.', '#880000 '], [2,5,3, '.', '#880000 '], [1,5,4, '.', '#880000 '],
		[6,5,1, '.', '#880000 '], [7,5,2, '.', '#880000 '], [8,5,3, '.', '#880000 '], [9,5,4, '.', '#880000 '],
		[4,5,9, '.', '#880000 '], [3,5,8, '.', '#880000 '], [2,5,7, '.', '#880000 '], [1,5,6, '.', '#880000 '],
		[6,5,9, '.', '#880000 '], [7,5,8, '.', '#880000 '], [8,5,7, '.', '#880000 '], [9,5,6, '.', '#880000 '],

		[3,5,3, '.', '#880000 '], [3,5,8, '.', '#880000 '], [8,5,3, '.', '#880000 '], [8,5,8, '.', '#880000 ']
